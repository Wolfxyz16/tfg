...
-- TODO we register the first ore and then ignore the others, we should consider every ore definition and group it into a fact
local ore_control = {}

local id_ore = 1

for _, ore in pairs(core.registered_ores) do
	if ore.ore ~= nil and ore.ore ~= "" and ore_control[ore.ore] ~= true then
